...
@Component({
  selector: 'app-lab-head',
  templateUrl: './lab-head.component.html',
  styleUrls: ['./lab-head.component.scss']
})
export class LabHeadComponent implements OnInit {
  ...
  public inItList(searchValue, pageNumber) {
    var reqObj = { pageNumber: pageNumber, status: 'LABHEAD', verifyByLabHead: this.listType };
    if (searchValue) {
